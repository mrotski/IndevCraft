...
export class Atmosphere {
  constructor(scene, sunLight) {
    ...
    this.sunSprite = new THREE.Sprite(new THREE.SpriteMaterial({
      map: loadCelestialTexture(celestialLoader, new URL("../sun.png", import.meta.url).href),
      transparent: true,
      depthWrite: false,
    }));
    ...
    this.moonSprite = new THREE.Sprite(new THREE.SpriteMaterial({
      map: loadCelestialTexture(celestialLoader, new URL("../moon.png", import.meta.url).href),
      transparent: true,
      depthWrite: false,
    }));
...
function loadCelestialTexture(loader, src) {
